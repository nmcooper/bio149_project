...
ak=1.74; % capture efficancy of species K (best logical guess)

rd=1.5; % growth rate of species D calculated from  loss estmate
ad=1.74; % capture efficancy of species D (best logical guess)
...
bd=0.25; % conversion efficeancy of prey D (best logical guess)
ac=0.067; % capture efficeancy of species C (Ostfeld 1982)
