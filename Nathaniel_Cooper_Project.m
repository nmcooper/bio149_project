...
% Paramters
time=1:500; % time span in years

rk=0.23; % growth rate of species K calculated from (Reed and Foster 1984) loss estmate
ak=0.90; % capture efficancy of species K (best logical guess)

rd=0.23; % growth rate of species D calculated from (Reed and Foster 1984) loss estmate
ad=0.90; % capture efficancy of species D (best logical guess)
...
n0=[355.5000;355.5000;337.500;405.0000;.003]; % starting pop size with biomass at next level calculated from (Reed and Foster 1984) and (Ostfeld 1982)

eq=0; % extinction level of population
%%
%for i=1:1 % solve ODE every seven days for 100 years 52 weeks * 100=5200 weekes
